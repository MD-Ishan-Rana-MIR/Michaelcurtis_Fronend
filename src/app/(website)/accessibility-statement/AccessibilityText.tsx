                    ...
                    <div className=' flex  gap-x-4  ' >
                        <div>
                            <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g clip-path="url(#clip0_243_1090)">
                        ...
                        <div>
                            <div className=' flex  gap-x-4  items-start ' >
                                <div>
                                    <svg width="36" height="35" viewBox="0 0 36 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <ellipse cx="18" cy="17.5" rx="18" ry="17.5" fill="#FAF5EC" />
                                        <g clip-path="url(#clip0_243_1115)">
                                            <path d="M14.25 29.25H24.75M17.25 11.25H27.75C28.1478 11.25 28.5294 11.408 28.8107 11.6893C29.092 11.9706 29.25 12.3522 29.25 12.75V23.25C29.25 23.6478 29.092 24.0294 28.8107 24.3107C28.5294 24.592 28.1478 24.75 27.75 24.75H11.25C10.8522 24.75 10.4706 24.592 10.1893 24.3107C9.90804 24.0294 9.75 23.6478 9.75 23.25V21.75H29.25M22.5 29.25H16.5L17.25 24.75H21.75L22.5 29.25Z" stroke="#D09A40" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6.75 15.75H14.25M8.25 6.75H12.75C12.75 6.75 14.25 6.75 14.25 8.25V17.25C14.25 17.25 14.25 18.75 12.75 18.75H8.25C8.25 18.75 6.75 18.75 6.75 17.25V8.25C6.75 8.25 6.75 6.75 8.25 6.75Z" stroke="#D09A40" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </g>
                                        <defs>
