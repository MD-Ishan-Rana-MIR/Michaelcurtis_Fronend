                    ...
                    <div className=' lg:w-[35%] w-full    ' >
                        ...
                        <div className='shadow shadow-[#00000033] bg-white lg:max-[20%] pt-3.5 px-8 rounded-[10px] pb-6 ' >
                            ...
                            <div className=' flex  items-center gap-x-5  ' >
                                <span>
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14.5 15V17C14.5 17.2652 14.3946 17.5196 14.2071 17.7071C14.0196 17.8946 13.7652 18 13.5 18H6.5L3.5 21V11C3.5 10.7348 3.60536 10.4804 3.79289 10.2929C3.98043 10.1054 4.23478 10 4.5 10H6.5M21.5 14L18.5 11H11.5C11.2348 11 10.9804 10.8946 10.7929 10.7071C10.6054 10.5196 10.5 10.2652 10.5 10V4C10.5 3.73478 10.6054 3.48043 10.7929 3.29289C10.9804 3.10536 11.2348 3 11.5 3H20.5C20.7652 3 21.0196 3.10536 21.2071 3.29289C21.3946 3.48043 21.5 3.73478 21.5 4V14Z" stroke="#D09A40" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                        ...
                        <div className='shadow shadow-[#00000033] bg-white lg:max-[20%] pt-3.5 px-8 rounded-[10px] pb-6 mt-5  ' >
                            ...
                            <div className=' flex justify-center ' >
                                <span><svg width="70" height="72" viewBox="0 0 70 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <rect x="1.02804" y="0.507042" width="67.9437" height="70.9859" rx="5.57747" stroke="#E9D1A7" stroke-width="1.01408" />
