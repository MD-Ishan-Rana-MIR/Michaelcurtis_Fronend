    ...
    return (
        <div className=' pt-3 lg:pt-5 pb-10 lg:pb-20 ' >
            <div className=' max-w-7xl mx-auto lg:px-4 ' >
                ...
                <div className=' flex flex-col lg:flex-row items-center justify-between my-12 gap-x-16 relative gap-y-6 lg:gap-y-0  ' >
                ...
                <div className="space-y-4 overflow-x-auto ">
                    {currentItems.map((item, i) => (
                        <div
                            key={item.rank}
                            className="flex flex-wrap items-center justify-center lg:justify-between bg-white border border-gray-300 rounded-xl p-4 shadow-lg"
                        >
