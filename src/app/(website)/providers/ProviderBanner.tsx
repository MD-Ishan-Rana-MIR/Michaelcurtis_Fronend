"use client"
import { Insurer } from '@/app/components/home/InsuranceCard';
                ...
                <div className=' flex flex-col md:flex-row gap-x-6 my-10 ' >
                    ...
                    <div className=' md:max-w-[20%]  flex-1 p-6 shadow-lg h-[80vh] w-full ' >
                        ...
                        <div className='mt-4' >
                            ...
                            <div className="flex flex-col items-center   rounded-lg px-4 py-2  border border-[#697079]   mt-2 ">
                                {/* Label */}
                                        ...
                                        <div className=' rounded-xl shadow-lg  ' key={i} >
                                            ...
                                            <div className=' mt-5 ' >
                                                <div className='  py-6 px-4  ' >
                                                    <div className=' flex justify-between items-center ' >
                                                        <span>
                                                            <svg width="51" height="54" viewBox="0 0 51 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <rect x="0.375" y="0.375" width="50.25" height="52.5" rx="4.125" stroke="#E9D1A7" stroke-width="0.75" />
                                                    ...
                                                    <div className=' mt-3  ' >
                                                        <h1 className=' text-black font-normal lg:text-[16px] text-xs ' >Progressive Insurance</h1>
                                                        <div className="flex items-center space-x-1 mt-2 ">
                                                            <span className="font-bold text-black lg:text-[16px] text-xs ">4.5</span>
                                                            {/* Full Stars */}
                                                            {[...Array(fullStars)].map((_, i) => (
                                                                // <svg key={`full-${i}`} xmlns="http://www.w3.org/2000/svg" fill="yellow" viewBox="0 0 24 24" width="20" height="20">
                                                    ...
                                                    <div className=' lg:mt-5 mt-2 ' >
                                                        <button className=' text-[#946D2D] lg:text-[14px] font-normal bg-[#F0E0C4] py-1 px-2 rounded-[3px] ' >
                                                            Sponsored
                                                        </button>
                                                    </div>
                                                    <div>
