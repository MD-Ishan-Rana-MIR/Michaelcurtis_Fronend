...
export default function AllReview() {
    ...
    const filteredReviews = initialReviews.filter((r) => {
        const matchesSearch = r.reviewer.toLowerCase().includes(search.toLowerCase()) || r.provider.toLowerCase().includes(search.toLowerCase());
        const matchesCategory = categoryFilter === "All" ? true : r.provider === categoryFilter;
            ...
            <div className=" bg-[#FAF5EC] shadow shadow-[#00000033] pt-5 pb-10 px-8 rounded-[12px] ">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex gap-4 flex-wrap">
                        <select value={categoryFilter} onChange={(e) => setCategoryFilter(e.target.value)} className="border border-gray-300 rounded px-3 py-2">
                            <option value="All">All Categories</option>
                            <option value="Virtue Insurance">Virtue Insurance</option>
                            <option value="Hope Coverage">Hope Coverage</option>
                            <option value="Gloirepaluku">Gloirepaluku</option>
                        </select>
