...
type PolicyViewProps = {
    uploadPolicyModal: boolean;
    setUploadPolicyModal: React.Dispatch<React.SetStateAction<boolean>>;
};

const AddPolicy: React.FC<PolicyViewProps> = ({
    uploadPolicyModal,
    setUploadPolicyModal,
}) => {
    ...
    const handleClose = useCallback(() => {
        setShowModal(false);
        setTimeout(() => setUploadPolicyModal(false), 500);
    }, [setUploadPolicyModal]);
          ...
          ${showModal ? "translate-y-20 opacity-100 scale-100" : "-translate-y-40 opacity-0 scale-95"}  `}
            >
                ...
                <div className="">
                    ...
                    <h1 className=" text-black text-4xl font-normal">Add New Policy Category</h1>
                </div>
