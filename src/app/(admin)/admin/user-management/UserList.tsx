...
// Sample user data
const usersData: User[] = Array.from({ length: 25 }).map((_, i) => ({
    id: i + 1,
    name: `User ${i + 1}`,
    image: "/images/user/user.png",
    role: i % 2 === 0 ? "Admin" : "User",
    status: i % 3 === 0 ? "Inactive" : "Active",
    joinDate: `2025-0${(i % 9) + 1}-0${(i % 28) + 1}`,
}));
            ...
            <div className="  mx-auto bg-[#FAF5EC] shadow shadow-[#00000033] py-9 px-8 rounded-[12px]  ">
                ...
                <div className="overflow-x-auto w-full  ">
                    <table className="min-w-full w-full ">
                        <thead className="   ">
                            <tr>
                                <th className="px-4 py-2 text-center text-[#000000] text-[16px] ">User</th>
                            ...
                            {displayedUsers.map((user) => (
                                <tr key={user.id} className="border-t border-gray-200 w-full  ">
                                    ...
                                    <td className=" text-center ">
                                        <button className="px-3.5 py-2 bg-[#EAEAEA] rounded-lg text-[#647268] text-xs font-normal  " >{user.role}</button>
                                    </td>
                                    <td className=" text-center ">
                                        <button className="px-3.5 py-2 bg-[#C8FFD1] rounded-lg text-[#24983F] text-xs font-normal  " >{user.status}</button>
                                    </td>
                                    ...
                                    <td className="px-4 py-2 flex gap-2 justify-center ">
                                        ...
                                        <button className="cursor-pointer border border-[#E04F4F] text-white px-2 py-1 rounded">
